...
int CScintillaCtrl::SetSelection(_In_ Sci_Position caret, _In_ Sci_Position anchor)
{
  return static_cast<int>(Call(SCI_SETSELECTION, static_cast<WPARAM>(caret), static_cast<LPARAM>(anchor)));
}

int CScintillaCtrl::AddSelection(_In_ Sci_Position caret, _In_ Sci_Position anchor)
{
  return static_cast<int>(Call(SCI_ADDSELECTION, static_cast<WPARAM>(caret), static_cast<LPARAM>(anchor)));
}
