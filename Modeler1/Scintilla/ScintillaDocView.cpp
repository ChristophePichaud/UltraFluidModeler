...
void CScintillaView::OnDestroy()
{
  ...
  if (_scintillaEditState.pFindReplaceDlg)
  {
    ...
    if (nScintillaViews == 0)
    {
      ...
      _scintillaEditState.pFindReplaceDlg = nullptr;
    }
  }
...
{
  //Validate our parameters
  AFXASSUME(_scintillaEditState.pFindReplaceDlg != nullptr);
...
void CScintillaView::OnEditFindReplace(_In_ BOOL bFindOnly)
{
  ...
  m_bFirstSearch = TRUE;
  if (_scintillaEditState.pFindReplaceDlg != nullptr)
  {
    ...
    else
    {
      ...
      _scintillaEditState.pFindReplaceDlg->SendMessage(WM_CLOSE);
      ASSERT(_scintillaEditState.pFindReplaceDlg == nullptr);
      ASSERT_VALID(this);
    }
  }
  CScintillaCtrl& rCtrl = GetCtrl();
