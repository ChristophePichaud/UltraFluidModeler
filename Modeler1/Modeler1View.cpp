...
BEGIN_MESSAGE_MAP(CModeler1View, CScrollView)
	...
	ON_COMMAND(ID_FILE_OPEN_AS_XML, &CModeler1View::OnFileLoadAsXML)
	ON_COMMAND(ID_FILE_SAVE_AS_XML, &CModeler1View::OnFileSaveAsXML)
...
void CModeler1View::OnFileSaveAsXML()
{
	GetManager()->Serialize_SaveAsXML(this);
}

void CModeler1View::OnFileLoadAsXML()
{
